...
jsonSource_Lokasi_Alternatif_SPBU_2.addFeatures(features_Lokasi_Alternatif_SPBU_2);var lyr_Lokasi_Alternatif_SPBU_2 = new ol.layer.Vector({
    ...
    <img src="styles/legend/Lokasi_Alternatif_SPBU_2_2.png" /> Sangat Sesuai<br />'
        });var format_Jalan_lokal_3 = new ol.format.GeoJSON();
var features_Jalan_lokal_3 = format_Jalan_lokal_3.readFeatures(json_Jalan_lokal_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:23889'});
var jsonSource_Jalan_lokal_3 = new ol.source.Vector({
    attributions: [new ol.Attribution({html: '<a href=""></a>'})],
});
jsonSource_Jalan_lokal_3.addFeatures(features_Jalan_lokal_3);var lyr_Jalan_lokal_3 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Jalan_lokal_3, 
                style: style_Jalan_lokal_3,
                title: '<img src="styles/legend/Jalan_lokal_3.png" /> Jalan_lokal'
            });var format_jalan_kolektor_4 = new ol.format.GeoJSON();
var features_jalan_kolektor_4 = format_jalan_kolektor_4.readFeatures(json_jalan_kolektor_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:23889'});
var jsonSource_jalan_kolektor_4 = new ol.source.Vector({
    attributions: [new ol.Attribution({html: '<a href=""></a>'})],
});
jsonSource_jalan_kolektor_4.addFeatures(features_jalan_kolektor_4);var lyr_jalan_kolektor_4 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_jalan_kolektor_4, 
                style: style_jalan_kolektor_4,
                title: '<img src="styles/legend/jalan_kolektor_4.png" /> jalan_kolektor'
            });var format_jalan_arteri_5 = new ol.format.GeoJSON();
var features_jalan_arteri_5 = format_jalan_arteri_5.readFeatures(json_jalan_arteri_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:23889'});
var jsonSource_jalan_arteri_5 = new ol.source.Vector({
    attributions: [new ol.Attribution({html: '<a href=""></a>'})],
});
jsonSource_jalan_arteri_5.addFeatures(features_jalan_arteri_5);var lyr_jalan_arteri_5 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_jalan_arteri_5, 
                style: style_jalan_arteri_5,
                title: '<img src="styles/legend/jalan_arteri_5.png" /> jalan_arteri'
            });

lyr_Batas_0.setVisible(true);lyr_perairandarat_1.setVisible(true);lyr_Lokasi_Alternatif_SPBU_2.setVisible(true);lyr_Jalan_lokal_3.setVisible(true);lyr_jalan_kolektor_4.setVisible(true);lyr_jalan_arteri_5.setVisible(true);
var layersList = [lyr_Batas_0,lyr_perairandarat_1,lyr_Lokasi_Alternatif_SPBU_2,lyr_Jalan_lokal_3,lyr_jalan_kolektor_4,lyr_jalan_arteri_5];
...
lyr_Jalan_lokal_3.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'LAYER': 'LAYER', 'KETERANGAN': 'KETERANGAN', 'SOURCETHM': 'SOURCETHM', 'LENGTH_FEE': 'LENGTH_FEE', 'SHAPE_LENG': 'SHAPE_LENG', 'SHAPE_LE_1': 'SHAPE_LE_1', 'SHAPE_LE_2': 'SHAPE_LE_2', });
lyr_jalan_kolektor_4.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'LAYER': 'LAYER', 'KETERANGAN': 'KETERANGAN', 'SOURCETHM': 'SOURCETHM', 'LENGTH_FEE': 'LENGTH_FEE', 'SHAPE_LENG': 'SHAPE_LENG', 'SHAPE_LE_1': 'SHAPE_LE_1', 'SHAPE_LE_2': 'SHAPE_LE_2', 'Foto': 'Foto', });
lyr_jalan_arteri_5.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'LAYER': 'LAYER', 'KETERANGAN': 'KETERANGAN', 'SOURCETHM': 'SOURCETHM', 'LENGTH_FEE': 'LENGTH_FEE', 'SHAPE_LENG': 'SHAPE_LENG', 'SHAPE_LE_1': 'SHAPE_LE_1', 'SHAPE_LE_2': 'SHAPE_LE_2', });
...
lyr_Jalan_lokal_3.set('fieldImages', {'OBJECTID': 'TextEdit', 'LAYER': 'TextEdit', 'KETERANGAN': 'TextEdit', 'SOURCETHM': 'TextEdit', 'LENGTH_FEE': 'TextEdit', 'SHAPE_LENG': 'TextEdit', 'SHAPE_LE_1': 'TextEdit', 'SHAPE_LE_2': 'TextEdit', });
lyr_jalan_kolektor_4.set('fieldImages', {'OBJECTID': 'TextEdit', 'LAYER': 'TextEdit', 'KETERANGAN': 'TextEdit', 'SOURCETHM': 'TextEdit', 'LENGTH_FEE': 'TextEdit', 'SHAPE_LENG': 'TextEdit', 'SHAPE_LE_1': 'TextEdit', 'SHAPE_LE_2': 'TextEdit', 'Foto': 'TextEdit', });
lyr_jalan_arteri_5.set('fieldImages', {'OBJECTID': 'TextEdit', 'LAYER': 'TextEdit', 'KETERANGAN': 'TextEdit', 'SOURCETHM': 'TextEdit', 'LENGTH_FEE': 'TextEdit', 'SHAPE_LENG': 'TextEdit', 'SHAPE_LE_1': 'TextEdit', 'SHAPE_LE_2': 'TextEdit', });
...
lyr_Jalan_lokal_3.set('fieldLabels', {'OBJECTID': 'no label', 'LAYER': 'no label', 'KETERANGAN': 'no label', 'SOURCETHM': 'no label', 'LENGTH_FEE': 'no label', 'SHAPE_LENG': 'no label', 'SHAPE_LE_1': 'no label', 'SHAPE_LE_2': 'no label', });
lyr_jalan_kolektor_4.set('fieldLabels', {'OBJECTID': 'no label', 'LAYER': 'no label', 'KETERANGAN': 'header label', 'SOURCETHM': 'no label', 'LENGTH_FEE': 'no label', 'SHAPE_LENG': 'no label', 'SHAPE_LE_1': 'no label', 'SHAPE_LE_2': 'no label', 'Foto': 'no label', });
lyr_jalan_arteri_5.set('fieldLabels', {'OBJECTID': 'no label', 'LAYER': 'no label', 'KETERANGAN': 'header label', 'SOURCETHM': 'no label', 'LENGTH_FEE': 'no label', 'SHAPE_LENG': 'no label', 'SHAPE_LE_1': 'no label', 'SHAPE_LE_2': 'no label', });
lyr_jalan_arteri_5.on('precompose', function(evt) {
